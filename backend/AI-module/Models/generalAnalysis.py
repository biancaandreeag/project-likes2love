...
class GeneralSentimentAnalyzer:
    ...
    def analyze_batch(self, texts):
        ...
        # Listă de comentarii cu label individual
        detailed_comments = []
        ...
        for text in texts:
            ...
            # Construiește obiectul detaliat pentru fiecare comentariu
        ...
        percent_counts = {
            label: round((counts[label] / total_texts) * 100, 1)
            for label in counts
        }

        avg_scores = {
            label: round((score_sums[label] / total_texts) * 100, 1)
